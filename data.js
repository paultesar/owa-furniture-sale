...
window.SALE = {
  ...
  items: [
    ...
    /* ===== TAKE-IT-ALL BUNDLE ===== */
    { id:"bundle-all", title:"Whole-home furniture package", price:800, status:"available", category:"Bundles", featured:true,
    ...
    { id:"cube-shelf", title:"6-cube storage shelf", price:40, status:"available", category:"Furniture",
